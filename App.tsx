...
import { processRecurringExpenses, cleanupAutoGeneratedExpenses } from './recurringLogic';
  ...
  useEffect(() => {
    ...
    const initSync = async (session: Session) => {
      try {
        ...
        void retrySyncQueue();
        // One-time cleanup of stale [Auto] expenses from old backfill logic
        void cleanupAutoGeneratedExpenses();
